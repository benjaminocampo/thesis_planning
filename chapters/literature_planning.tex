...
importancia para comprender el enfoque de la tesis.
...
acciones, y objetivos a ser satisfechos. El modelo conceptual del dominio en el
...
incluir una explícita enumeración de todos los estados y transiciones que se
...
AIPS-98 \citep{McDermott1998} siendo la herramienta más conocida y usada dentro
...
PSPACE-completo, lo cual lo hace intratable para problemas complejos. Sin embargo,
en ocasiones se suelen
