...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            ...
            {\LARGE 
                ...
                Co-Director: Dr. Martín Dominguez \\
                % change the following line                
                }\\[1cm] % if applicable
            
            \vfill
    		% PLEASE DO NOT CHANGE THIS TEXT %
            \LARGE Trabajo especial de la carrera Licenciatura en Ciencias de la Computación\\[0.3cm] 
            
            \vspace{0.8cm}
            
            \includegraphics[width=0.5\textwidth]{unc3_a.jpg}
    ...
    \hspace{0pt}
    \vfill
    \emph{Para mi madre Josefina,
    por escucharme, acompañarme, \\ y ser el pilar importante en lo que hoy soy.}
    \vfill
    \hspace{0pt}
